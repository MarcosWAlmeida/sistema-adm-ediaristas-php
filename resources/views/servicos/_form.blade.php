            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input value="{{$servico->nome ?? ''}}" type="input" class="form-control" name="nome" id="nome" required placeholder="Nome do serviço">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{$servico->valor_banheiro ?? ''}}"type="input" class="form-control" name="valor_banheiro" id="valor_banheiro" required placeholder="Valor por cozinha">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="horas_cozinha">Quantidade de horas por banheiro</label>
                        <input value="{{$servico->horas_banheiro ?? ''}}" type="input" class="form-control" name="horas_banheiro" id="horas_banheiro" required placeholder="Quantidade horas por cozinha">
                    </div>
                </div>
            </div>
